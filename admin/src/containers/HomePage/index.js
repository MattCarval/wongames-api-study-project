...
const SOCIAL_LINKS = [
  {
    name: 'LinkedIn',
    link: 'https://www.linkedin.com/in/mattcarval/',
  },
  {
    name: 'GitHub',
    link: 'https://github.com/MattCarval',
  },
  {
    name: 'Instagram',
  ...
  {
    name: 'Twitter',
    link: 'https://twitter.com/MattCarval',
  },
];
        ...
        <div className="row">
            ...
            <Block>
              ...
              {hasAlreadyCreatedContentTypes ? (
                <FormattedMessage id="app.components.HomePage.welcomeBlock.content.again">
                  {msg => <P>Ao lado você pode inserir diferenets jogos, categorias e publishers para nossa maravilhosa loja de jogos!</P>}
                </FormattedMessage>
              ) : (
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
             ...
             <P style={{ marginTop: 7, marginBottom: 0 }}>Quer me conhecer ou onversar comigo? Entre em contanto em qualquer um dos links abaixo!</P>
